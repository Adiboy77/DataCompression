...
unordered_map<char, unsigned char> mm1;
#define MAX_SIZE 100
...
//Press ctrl + C if runtime loop hang, or select cancel build from tools option.
  ...
  cout << endl;
  //Wrong mappings of whole keyboard: Nothing
  //cout << "Check " << mm1['i'] << " " << endl;
  //TODO:
  //cout << mm2['ß'] << endl;
  /*/Users/adityavikramtiwari/Documents/HE9.cpp:374:15: error: character too large for enclosing character literal type
  cout << mm2['ß'] << endl;*/
  //Check and optimize the limits of distinct characters in input string and unsigned char compatibility
  //See and try to eliminate hex values appearing in the output
  return 0;
}
